export const siteConfig = {
  ...
  description: 'Servicios profesionales de manicure, pedicure y uñas en polygel en Cali, Colombia',
  ...
  seo: {
    ...
    defaultTitle: 'Vane Style - Uñas Profesionales en Cali',
    keywords: [
      'manicure Cali',
      'pedicure Cali',
      'uñas polygel Cali',
